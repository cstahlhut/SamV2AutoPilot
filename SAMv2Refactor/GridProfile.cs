...
namespace IngameScript
{
    partial class Program
    {
        ...
        { // Profiles
            ...
            private static string[] meTags = new string[] { "DEBUG", ADVERTISE_TAG, NO_DAMPENERS_TAG, ESCAPE_NOSE_UP_TAG,
                SLOW_ON_APPROACH_TAG, ALLOW_DIRECT_ALIGNMENT_TAG, IGNORE_GRAVITY_TAG, LEADER_TAG };
            private static string[] cockpitPanelTags = new string[] { TEXT_STYLE_OVERRIDE_TAG };
            private static string[] textPanelTags = new string[] { TEXT_STYLE_OVERRIDE_TAG };
            ...
            public static string[] panelTags = new string[] { "Panel0", "Panel1", "Panel2", "Panel3", "Panel4",
            ...
            private static string[] pbAttributes = new string[]{
                ...
                NAME_TAG, MAX_SPEED_TAG, WAIT_TAG, TAXI_SPEED_TAG, CONNECTOR_REVERSE_TAG, APPROACH_SAFE_DISTANCE_TAG, APPROACH_DISTANCE_TAG, DOCK_DISTANCE_TAG,
                ...
                AUTO_CRUISE_TAG, DESCEND_NOSE_DOWN_ELEVATION_TAG, AGGRO_TAG, MASS_EXCESS_TAG, EFFECTIVE_THRUST_TAG};
